...
# 加载数据集
file_path = '/Users/jiaoyihan/capstone/capstone_project/emails.csv'
...
# 应用预处理函数到message列
data['Cleaned_Message'] = data['message'].apply(simple_preprocess_text)
...
# 拟合并转换清理后的文本数据
ngram_matrix = ngram_vectorizer.fit_transform(data['Cleaned_Message'])
...
output_file_path = '/Users/jiaoyihan/capstone/capstone_project/Processed_emails_ngram.csv'
